...
mytrain=open('/media/smartspace/New Volume1/FDL/ssfeatslabeltrain.csv','a')
wr=csv.writer(mytrain,quoting=csv.QUOTE_ALL)

mytest=open('/media/smartspace/New Volume1/FDL/ssfeatslabeltest.csv','a')
